...
void DrawSpriteField(FIELD_TEXTURE_NUM texNum, Float2 Pos)
{
	...
	float hw, hh;
	hw = GetFieldTextureInf(texNum)->fieldsize.x * 0.5f;
	hh = GetFieldTextureInf(texNum)->fieldsize.y * 0.5f;
	...
	// テクスチャ設定
	GetDeviceContext()->PSSetShaderResources(0, 1, GetTexture(GetFieldTextureInf(texNum)->fileNum));

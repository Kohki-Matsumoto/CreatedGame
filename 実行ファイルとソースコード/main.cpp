...
#define WINDOW_CAPTION		"リズム=Brain"			// ウインドウのキャプション名

#define DEBUGMODEON			false					//デバッグモードのオンオフ(treu = オン)
//*****************************************************************************
// 構造体定義
//*****************************************************************************
...
//*****************************************************************************
HWND p_windinf;
float WindowRatio;							//システムのアイコンの拡大率(詳しくは齋藤まで)
#ifdef _DEBUG
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	hWnd = CreateWindow(
		CLASS_NAME,
		WINDOW_CAPTION,
		WS_POPUPWINDOW,			//ここを WS_POPUPWINDOW に変えることでフルスクリーンになります。(詳細は定義へGo！)
		CW_USEDEFAULT,																		// ウィンドウの左座標
		CW_USEDEFAULT,																		// ウィンドウの上座標
		(int)((float)SCREEN_WIDTH * WindowRatio),																		// ウィンドウ横幅
		(int)((float)SCREEN_HEIGHT * WindowRatio),																		// ウィンドウ縦幅
		NULL,
		NULL,
		hInstance,
		NULL);
